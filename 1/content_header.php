<header class="main-header">
  <!-- Logo -->
  <div class="logo">
<span class="logo-mini"><img src="../aset/foto/unis-icon.png" class="img-circle" alt="Logo" height="40" width="40"></span>
<span class="logo-lg"><b>UNIS TANGERANG</b></span>
</div>
